    ...
    for k in K_FACTORS:
        ...
        for v_1 in V_1_RANGE:
            ...
            current_frame["bin_len"] = \
                current_frame["v_i"].apply(log2).astype('int64') + 1

            current_frame["next_bin_len"] = \
                current_frame["kv_i+1"].apply(log2).astype('int64') + 1
            ...
            current_frame["lambda"] = current_frame["lambda_i"].cumsum()
            ...
            current_frame["omega"] = current_frame["lambda"] - current_frame["alpha"]
