...
## Collatz binary leading graph
<!-- #endregion -->

```python pycharm={"name": "#%%\n"}
"""
This experimental notebook analyses the binary representation of Collatz sequences from
a graph-theoretic perspective and focuses on the leading digits. It builds on a sample
...
EXPORT_PIC_PATH = DATA_PATH + "binary_leading_graph.png"
EXPORT_CSV_PATH = DATA_PATH + "binary_leading_graph.csv"
SHOW_LABELS = True
...
# three leading bits
analysis_frame = analysis_frame[analysis_frame["bin_len"] >= 3]
```

```python pycharm={"name": "#%%\n"}
analysis_frame["predecessor"] = analysis_frame["l123"]
...
edge_labels = nx.get_edge_attributes(network,'l_min')
